...
See `guidelines/frontend/design-system.md` for the full framework: token categories, foundational component contracts, page archetypes, and designer boundary. Project-specific token values and component status live in CLAUDE.md (generated by `/setup-project`).
